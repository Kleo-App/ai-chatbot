      ...
      <div className={`flex flex-col ${children ? 'h-full' : 'min-h-screen'}`}>
          ...
          <section id="hero" className="w-full relative">
            <div className="relative flex flex-col items-center w-full px-6">
              ...
              <div className="absolute inset-0 -top-20 -z-10">
                <div className="absolute inset-0 h-[1800px] w-full bg-gradient-radial from-white via-blue-50/80 to-purple-100/60"></div>
              ...
              <div className="relative z-10 pt-24 pb-48 max-w-3xl mx-auto w-full flex flex-col gap-6 items-center">
                ...
                <div className="relative mt-4 w-full max-w-3xl mx-auto">
                  <div className="[&_textarea]:text-lg [&_textarea]:min-h-[120px] [&_textarea]:py-6 [&_textarea]:px-6 [&_.bg-white]:shadow-2xl [&_.rounded-2xl]:rounded-3xl">
        ...
        {showHeader && (
          <div className="w-full relative z-20 -mt-24 px-8">
            ...
            {/* Testimonial Section */}
            <div className="bg-gray-900 pt-16 pb-16 mb-[-2rem] rounded-b-[20px]" style={{ width: 'calc(100% + 4rem)', marginLeft: '-2rem', marginRight: '-2rem' }}>
